...
export default function FloatingTab() {
  return (
    <div className='absolute top-143 left-1/2 -translate-x-1/2 bg-gray-100 rounded-2xl shadow-lg w-11/12 max-w-7xl h-20 z-50 flex flex-row justify-around p-2'>
      ...
      <div className='flex flex-col'>
        <h1 className='text-sm text-gray-600'>Guest</h1>
        <input
          type='type'
          placeholder='Guest'
          className='text-xs font-extralight border p-2  rounded-2xl border-gray-500 focus:outline-none'
